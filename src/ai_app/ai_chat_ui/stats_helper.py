...
def extract_context_window(metadata: Dict[str, Any]) -> Optional[int]:
    """
...
def extract_context_usage_percent(metadata: Dict[str, Any]) -> Optional[float]:
    """
...
def extract_elapsed_ms(metadata: Dict[str, Any]) -> Optional[int]:
    """
